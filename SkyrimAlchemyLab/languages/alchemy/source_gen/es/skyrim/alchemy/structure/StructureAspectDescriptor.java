...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  private static String[] stringSwitchCases_1htk8d_a0a0a = new String[]{"es.skyrim.alchemy.structure.AlchemyLab", "es.skyrim.alchemy.structure.Effect", "es.skyrim.alchemy.structure.EffectAlias", "es.skyrim.alchemy.structure.EffectReference", "es.skyrim.alchemy.structure.IEffect", "es.skyrim.alchemy.structure.Ingredient", "es.skyrim.alchemy.structure.IngredientReference", "es.skyrim.alchemy.structure.Mixture", "es.skyrim.alchemy.structure.Recipe"};
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0a, conceptFqName)) {
      case 0:
        return new CompiledConceptDescriptor("es.skyrim.alchemy.structure.AlchemyLab", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.IContainer", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{}, new String[]{});
      case 1:
      ...
      case 5:
        return new CompiledConceptDescriptor("es.skyrim.alchemy.structure.Ingredient", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{"price", "weight", "source"}, new String[]{});
      case 6:
      ...
      case 7:
        return new CompiledConceptDescriptor("es.skyrim.alchemy.structure.Mixture", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{}, new String[]{});
      case 8:
